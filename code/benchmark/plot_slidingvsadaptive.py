...
base_dir = 'results_so'
variants = ['base', 'prop', 'dens', 'dens_reach', 'prop_density', 'prop_dens_reach']

# Initialize an empty DataFrame with the specified structure
columns = ['q1', 'q2', 'q3', 'q4', 'q5', 'q7', 'q9']
index = pd.MultiIndex.from_product([['86400', '129600', '172800'], range(1, 7)], names=['row', 'variant'])
...
def parse_file(file_path):
    with open(file_path, 'r') as file:
        ...
        value = resulting_paths / execution_time
        return value
